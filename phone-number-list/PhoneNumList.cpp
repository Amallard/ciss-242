/* Adam Allard
* This program allows a user to search a list of phone numbers and names 
* providing a name or part of a name. could not find an effective way to 
* utilize a case insensitive search :/
*/
